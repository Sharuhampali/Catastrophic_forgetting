...
#             for idx, cls in enumerate(allowed_classes):
...
#             test_loss, accuracy = test(model, criterion, eval_loader, device, allowed_classes=eval_classes)
#             results[eval_task_id].append(accuracy)
#             print(f"  Eval on Task {eval_task_id+1}: Accuracy = {accuracy*100:.2f}%")
...
#     plt.xlabel("Task Sequence")
#     plt.ylabel("Test Accuracy")
#     plt.title("Continual Learning with Replay and Task-Aware Evaluation")
#     plt.ylim(0, 1.05)
#     plt.legend()
#     plt.grid(True)
#     plt.show()
